 ...
 * desc   :
 */
public class ReenterSlide extends Transition {
    ...
    public void captureEndValues(TransitionValues transitionValues) {
        transitionValues.values.put(LEFT, 0);
        transitionValues.values.put(RIGHT, rect.width());
    }

    @Override
    public Animator createAnimator(ViewGroup sceneRoot, TransitionValues startValues, TransitionValues endValues) {
        View endView = endValues.view;
        ObjectAnimator animator = ObjectAnimator.ofFloat(endView, "translationX",  -rect.width(),rect.width())
